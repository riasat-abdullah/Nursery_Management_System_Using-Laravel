...
<br>
<img src="http://localhost/ecommerce-website-php/mvc/view/admin_images/<?Php echo $admin_image; ?>" width="70" height="70" >
...
move_uploaded_file($temp_admin_image,"http://localhost/ecommerce-website-php/mvc/view/admin_images/$admin_image");
