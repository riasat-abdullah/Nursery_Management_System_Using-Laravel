  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Register</span> AT PLANTIFY
      </div>
      <p class="nero__text">
      </p>
    </div>
...
move_uploaded_file($c_image_tmp,"http://localhost/ecommerce-website-php/mvc/view/customer_images/$c_image");
