      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="../../controller/index.php">
            <img class="logo__img" src="http://localhost/ecommerce-website-php/mvc/view/Customer_Style/images/logo.png" alt="logotype" width="237" height="19">
          </a>
        </div>
        ...
        <nav class="main-nav">
          <ul class="categories">
            ...
            <li class="categories__item">
              <a class="categories__link" href="http://localhost/ecommerce-website-php/mvc/controller/index.php">
                Home
              ...
              <li class="categories__item">
              <a class="categories__link" href="http://localhost/ecommerce-website-php/mvc/model/about.php">
                About Us
              ...
              <li class="categories__item">
              <a class="categories__link" href="http://localhost/ecommerce-website-php/mvc/model/contact.php">
                Contact Us
              ...
              <li class="categories__item">
              <a class="categories__link" href="http://localhost/ecommerce-website-php/mvc/model/terms.php">
                Terms & Condition
            ...
            <li class="categories__item">
              <a class="categories__link categories__link--active" href="http://localhost/ecommerce-website-php/mvc/model/shop.php">
                Shop
              </a>
            </li>
